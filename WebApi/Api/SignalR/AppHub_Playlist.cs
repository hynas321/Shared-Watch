...
public partial class AppHub : Hub
{
    ...
    public async Task AddPlaylistVideoAsync(string roomHash, PlaylistVideo playlistVideo)
    {
        ...
        var isPlaylistVideoAdded = await _playlistRepository.AddPlaylistVideoAsync(roomHash, playlistVideo, Context.ConnectionAborted);
    ...
    public async Task DeletePlaylistVideoAsync(string roomHash, string videoHash)
    {
        ...
        await Clients.Group(roomHash).SendAsync(HubMessages.OnDeletePlaylistVideo, videoHash, Context.ConnectionAborted);
    }
